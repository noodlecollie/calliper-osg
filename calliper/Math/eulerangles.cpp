...
namespace EulerAngles
{
    ...
    {
        return osg::Matrixd::rotate(quatForAngles(pitch, yaw, roll));
    }

    osg::Quat quatForAngles(float pitch, float yaw, float roll)
    {
        return CalliperMath::quatRotation(CalliperMath::CardinalAxis::X, roll) *
               CalliperMath::quatRotation(CalliperMath::CardinalAxis::Y, pitch, true) *
               CalliperMath::quatRotation(CalliperMath::CardinalAxis::Z, yaw);
    }
}
